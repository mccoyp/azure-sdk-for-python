...
class Action(_model_base.Model):
    ...
    :vartype action_type: str or ~azure.keyvault.certificates.models.ActionType
    """
...
class BackupCertificateResult(_model_base.Model):
    ...
    value: Optional[bytes] = rest_field(format="base64")
...
class CertificateAttributes(_model_base.Model):
    ...
    :ivar recovery_level: Reflects the deletion recovery level currently in effect for certificates
     ...
     the certificate, at the end of the retention interval. Known values are: "Purgeable",
    ...
    expires: Optional[datetime.datetime] = rest_field(format="unix-timestamp")
    """Expiry date in UTC."""
...
class CertificateBundle(_model_base.Model):
    ...
    """The secret id."""
    x509_thumbprint: Optional[bytes] = rest_field(name="x5t", visibility=["read"], format="base64")
...
class CertificateImportParameters(_model_base.Model):
    ...
    :ivar base64_encoded_certificate: Base64 encoded representation of the certificate object to
     import. This
     certificate needs to contain the private key. Required.
...
class CertificateIssuerItem(_model_base.Model):
    ...
    :ivar id: Certificate Identifier. Required.
    :vartype id: str
    ...
    """Certificate Identifier. Required."""
...
class CertificateItem(_model_base.Model):
    ...
    tags: Optional[Dict[str, str]] = rest_field()
    """Application specific metadata in the form of key-value pairs."""
    x509_thumbprint: Optional[bytes] = rest_field(name="x5t", format="base64")
    """Thumbprint of the certificate."""
...
class CertificateListResult(_model_base.Model):
    ...
    :ivar value: The CertificateItem items on this page. Required.
    :vartype value: list[~azure.keyvault.certificates.models.CertificateItem]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """

    value: List["_models.CertificateItem"] = rest_field()
    """The CertificateItem items on this page. Required."""
    ...
    def __init__(
        self,
        *,
        value: List["_models.CertificateItem"],
...
class CertificateRestoreParameters(_model_base.Model):
    ...
    certificate_bundle_backup: bytes = rest_field(name="value", format="base64")
...
class DeletedCertificateBundle(_model_base.Model):  # pylint: disable=too-many-instance-attributes
...
class DeletedCertificateItem(_model_base.Model):
    ...
    x509_thumbprint: Optional[bytes] = rest_field(name="x5t", format="base64")
    """Thumbprint of the certificate."""
    recovery_id: str = rest_field(name="recoveryId")
    """The url of the recovery object, used to identify and recover the deleted
     certificate. Required."""
    scheduled_purge_date: Optional[datetime.datetime] = rest_field(
        name="scheduledPurgeDate", visibility=["read"], format="unix-timestamp"
