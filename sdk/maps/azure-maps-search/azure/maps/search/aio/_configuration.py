...
class MapsSearchClientConfiguration:  # pylint: disable=too-many-instance-attributes
    ...
    :keyword api_version: The API version to use for this operation. Known values are
     "2025-06-01-preview" and None. Default value is "2025-06-01-preview". Note that overriding this
