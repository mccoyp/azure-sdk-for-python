...
def build_maps_render_get_map_tile_request(
    *,
...
def build_maps_render_get_map_tileset_request(  # pylint: disable=name-too-long
...
def build_maps_render_get_map_attribution_request(  # pylint: disable=name-too-long
    *,
    tileset_id: Union[str, _models.TilesetID],
    zoom: int,
    bounds: list[float],
...
def build_maps_render_get_map_state_tile_request(  # pylint: disable=name-too-long
...
def build_maps_render_get_copyright_caption_request(  # pylint: disable=name-too-long
...
def build_maps_render_get_map_static_image_request(  # pylint: disable=name-too-long
    *,
    client_id: Optional[str] = None,
...
def build_maps_render_get_copyright_from_bounding_box_request(  # pylint: disable=name-too-long
...
def build_maps_render_get_copyright_for_tile_request(  # pylint: disable=name-too-long
    format: Union[str, _models.ResponseFormat],
    *,
    z: int,
    x: int,
...
def build_maps_render_get_copyright_for_world_request(  # pylint: disable=name-too-long
    format: Union[str, _models.ResponseFormat],
    *,
    client_id: Optional[str] = None,
    include_text: Optional[Union[str, _models.IncludeText]] = None,
...
class _MapsRenderClientOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], MapsRenderClientConfiguration]
):
    ...
    def get_map_tile(
        ...
        **kwargs: Any
        ...
        _request = build_maps_render_get_map_tile_request(
    ...
    def get_map_tileset(
        ...
        _request = build_maps_render_get_map_tileset_request(
            tileset_id=tileset_id,
            client_id=client_id,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    def get_map_attribution(
        ...
        **kwargs: Any
        ...
        _request = build_maps_render_get_map_attribution_request(
            tileset_id=tileset_id,
            zoom=zoom,
            bounds=bounds,
            client_id=client_id,
    ...
    def get_map_state_tile(
        ...
        _request = build_maps_render_get_map_state_tile_request(
            z=z,
            x=x,
            y=y,
    ...
    def get_copyright_caption(
        ...
        _request = build_maps_render_get_copyright_caption_request(
            format=format,
            client_id=client_id,
            api_version=self._config.api_version,
            headers=_headers,
    ...
    def get_map_static_image(  # pylint: disable=too-many-locals
        ...
        *Note* : Either **center** or **bbox** parameter must be supplied to the API.
        ...
        _request = build_maps_render_get_map_static_image_request(
            client_id=client_id,
            tileset_id=tileset_id,
    ...
    def get_copyright_from_bounding_box(
        ...
        **kwargs: Any
        ...
        _request = build_maps_render_get_copyright_from_bounding_box_request(
            format=format,
    ...
    def get_copyright_for_tile(
        ...
        **kwargs: Any
        ...
        _request = build_maps_render_get_copyright_for_tile_request(
            format=format,
            z=z,
            x=x,
            y=y,
    ...
    def get_copyright_for_world(
        ...
        **kwargs: Any
        ...
        _request = build_maps_render_get_copyright_for_world_request(
            format=format,
            client_id=client_id,
            include_text=include_text,
            api_version=self._config.api_version,
