...
class CountryRegion(_Model):
    ...
    :ivar iso_code: The IP address's 2-character country or region code (`ISO 3166-1
     <https://www.iso.org/iso-3166-country-codes.html>`_). Note that IP addresses in ranges reserved
     for special purposes will return Null for country/region.
    :vartype iso_code: str
    """

    iso_code: Optional[str] = rest_field(name="isoCode", visibility=["read"])
    """The IP address's 2-character country or region code (`ISO 3166-1
     <https://www.iso.org/iso-3166-country-codes.html>`_). Note that IP addresses in ranges reserved
     for special purposes will return Null for country/region."""
